...
```{r init-clt, error=FALSE, warning=FALSE, message=FALSE}
rm(list=ls())
...
```{r prep-data-clt, warning=FALSE, error=FALSE, message=FALSE}
...
```{r script, results='asis', echo=FALSE}
cat('<script>
$(function(){
  var image = new Image();
...
```{r plot-clt, warning=FALSE, error=FALSE,  fig.path="../assets/plots/"}
